  ...
  () => [
{
  ...
  description: "An AI-powered mock interview platform that simulates realistic interviews, analyzes user responses, and provides instant AI feedback to improve communication and confidence.",
  image: "/interview.png",
  tech: ["Next.js", "React 19", "Node.js", "MongoDB", "Gemini API", "Tailwind CSS", "shadcn/ui"],
  github: "https://github.com/samikhan1239/interview-prep-ai",
  live: "https://interview-two-psi.vercel.app/",
  featured: true,
  categories: ["AI", "Full Stack", "Interview", "Real Time", "Education"],
  type: "AI-Powered, Full Stack, Interview Simulation, Real Time",
  duration: "Sep 2025 - Oct 2025",
  team: "Solo",
  stats: {
    users: "50+ Active Testers",
    interviews: "AI Mock Sessions",
    feedback: "Instant AI Scoring",
  },
  highlights: [
    "Developed an AI-driven mock interview platform with real-time video-based Q&A.",
    "Integrated resume parsing for auto-extraction of candidate details and personalized sessions.",
    "Implemented an AI feedback engine to assess clarity, confidence, and technical accuracy.",
    "Added Practice Mode for users to create custom questions with automated evaluation.",
  ],
